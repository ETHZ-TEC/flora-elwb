...
/* debugging */
  ...
  #define IDLE_TASK_SUSPENDED()         //PIN_CLR(COM_GPIO2)
    ...
    #define RADIO_TX_START_IND()        PIN_SET(FLOCKLAB_LED1)
    #define RADIO_TX_STOP_IND()         PIN_CLR(FLOCKLAB_LED1)
    #define RADIO_RX_START_IND()        PIN_SET(FLOCKLAB_LED1)
    #define RADIO_RX_STOP_IND()         PIN_CLR(FLOCKLAB_LED1)
    ...
    #define RADIO_RX_START_IND()        //PIN_SET(COM_GPIO2)
    #define RADIO_RX_STOP_IND()         //PIN_CLR(COM_GPIO2)
